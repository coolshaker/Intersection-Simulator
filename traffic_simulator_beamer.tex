...
\title{Traffic Simulator Project}
\subtitle{Beamer Presentation for the Intersection Simulator}
\author{Dr. Kun Xie}
\institute{Old Dominion University \\ Transportation Informatics Lab}
\date{\today}
